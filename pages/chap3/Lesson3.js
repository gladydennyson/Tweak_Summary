...
<Text style={styles.wordHeading}>For and Since - Period</Text>

<Text style={styles.subheading}>For:</Text>
<Text style={styles.examples}>{`❎I am excited for the new Apple watch.\n✅ I am excited about the new Apple watch.\n`}
</ Text>

<Text style={styles.subheading}>For and Since</Text>
<Text style={styles.examples}>{`word “for” you are measuring time.\nword “since” you are referring to a specific time.\n`}
</ Text>



<Text style={styles.examples}>{`❎She had been driving since four hours.\nShe had been driving for four hours.\n`}
</ Text>

          
<Text style={styles.examples}>{`❎I haven’t seen him for last year.\n✅ I haven’t seen him since last year.\n`}
</ Text>


<Text style={styles.examples}>{`❎They have known each other for eight years’\n✅Theysince\n`}
</ Text>  
 </ScrollView>      
