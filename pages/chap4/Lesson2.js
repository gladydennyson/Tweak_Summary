...
<Text style={styles.bodyHeaading}>How to use the word “Beat”</Text>
<Text style={styles.subheading}>Bate and Beated both are incorrect words.</Text>

<Text style={styles.examples}>{`✅Beat and Beaten\n`}</Text>
  <Text style={styles.examples}>{`❎He had beated him.\n✅He had beaten him\n`}
</Text>

<Text style={styles.examples}>{`❎The goons finally beated them all.\n✅The goons finally beat them all.\n`}
</ Text>
</ScrollView>
...
<Text style={styles.wordHeading}>Bet and Hit</Text>

<Text style={styles.examples}>{`❎Betted.\n❎Hitted.\n`}
</ Text>

<Text style={styles.examples}>{`✅He had betted against her wish.\n✅He had bet against her wish.\n`}
</ Text>

<Text style={styles.examples}>{`✅He hitted the ball out of the stadium.\n✅He hit the ball out of the stadium.`}</Text>
</ScrollView>
       ...
       <View style={styles.row3}>
         ...
         <View style={styles.row1}>
          ...
          <View style={styles.row2}>
 <ScrollView showsVerticalScrollIndicator={true}>           
 <Text style={styles.wordHeading}>Talked | Phoned</Text>
<Text style={styles.subheading}>Although they might sound wrong, talked and phoned are words which can be used in the right sentence.</Text>
