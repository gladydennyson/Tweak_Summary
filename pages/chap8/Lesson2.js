...
<Text style={styles.bodyHeaading}>Phenomenon - a remarkable person or thing</Text>
<Text style={styles.subheading}>{`Singular form: phenomenon\nPlural form: phenomena`}</Text>
...
<ScrollView showsVerticalScrollIndicator={true}>
<Text style={styles.wordHeading}>Person, persons and people</Text>
<Text style={styles.subheading}>We use person in the singular to refer to any human being:</Text>

<Text style={styles.examples}>{`Joel is such a nice person.\nShe’s a person I have a lot of respect for.\n`}</Text>
<Text style={styles.examples}>{`Persons (plural) is a very formal word.`}</Text>

<Text style={styles.examples}>{`Any person or persons found in possession of illegal substances will be prosecuted.\n`}</Text>
</ScrollView>
          </View>
...
<ScrollView showsVerticalScrollIndicator={true}>
<Text  style={styles.subheading}>To refer to groups of human beings or humans in general, we use people:</Text>

<Text style={styles.examples}>{`\n✔☑✔️✅I saw three people standing on the corner.\n❎I saw three persons standing on the corner.\n`}</Text>
<Text style={styles.examples}>{`Jim and Wendy are such nice people.\n\nPeople are generally very selfish.\n\nThree people were interviewed for the job, but only one person had the right qualifications and experience.`}</Text>
