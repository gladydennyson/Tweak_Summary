...
<Text style={styles.bodyHeaading}>{`A large amount`}</Text>

<Text style={styles.subheading}>{`A lot of.\nMuch\nSevera\n`}
</Text>


<Text  style={styles.bodyHeaading}>Small in amount</Text>

<Text style={styles.subheading}>{`Few\nLittle\nLess`}
</Text>
